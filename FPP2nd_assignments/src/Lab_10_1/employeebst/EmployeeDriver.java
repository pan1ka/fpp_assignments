...
import Lab_10_1.bst.EmployeeBST;
...
public class EmployeeDriver {
	...
	public EmployeeDriver() {
		...
		System.out.println(bst.find(new Employee("Sally", 45000, 2001, 2, 7)));
		System.out.println(bst.find(new Employee("Alex", 45000, 2001, 2, 7)));
