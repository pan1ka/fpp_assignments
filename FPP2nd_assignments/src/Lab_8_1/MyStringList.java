...
public class MyStringList {
	...
	public int minpos(int bottom, int top) {
		...
		for (int i = bottom + 1; i <= top; ++i) {
			// System.out.println(strArray[i] + " top=" + top + "m=" + m);
	...
	public static void main(String[] args) {
		...
		l.sort();
		System.out.println("The SORTED list of size " + l.size() + " is " + l);
		System.out.println(l.search("number")); // false
		System.out.println(l.search("tiny")); // true
		System.out.println(l.search("vast")); // true
	}
